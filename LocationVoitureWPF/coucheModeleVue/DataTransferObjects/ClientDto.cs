...
namespace LocationVoitureWPF.coucheModeleVue.DataTransferObjects
{
    public class ClientDto
    {
        ...
        public ClientDto(int id, string nom, string prenom, DateTime dateNaissance, string numPermisConduire,
                        string pays, string region, string ville, string adresse, string cp)
        {
            Id = id;
            Nom = nom;
            Prenom = prenom;
